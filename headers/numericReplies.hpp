...
# define ERR_TOOMANYMEMBERS(nick, channel, maxClients) (":localhost 954 " + nick + " :The number of max Users set for the channel " + channel + " is superior than the max clients in the server: " + maxClients + "\r\n")
